...
//Put path All Researchers
	...
	public String updateResearcher(String researcherData) {
		...
		String output = researcherObj.updateResearcher( researcherID, researcherFname,  researcherLname,  researcherGender, researcherPhone,researcherBirthday,  researcherPassword,researchDetails,accountnumber,bankname) ;
		return output;
	}
